      ...
      {hasTrainedModels && (
        <>
          <Card className='shadow-xl border-0 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm overflow-hidden'>
            <CardHeader className='pb-6 border-b border-border/50 bg-slate-50/50 dark:bg-slate-900/50'>
              ...
              <CardDescription className='text-lg text-slate-600 dark:text-slate-300 ml-14'>
                Enter participant details to predict bootcamp success using your
                trained models
              </CardDescription>
            </CardHeader>
